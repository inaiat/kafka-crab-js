...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./pdf-crab-js.wasi.cjs', false, ["./pdf-crab-js.wasm32-wasi.debug.wasm","./pdf-crab-js.wasm32-wasi.wasm"])
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('pdf-crab-js-wasm32-wasi', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
...
const { PdfDocumentBuilder, PdfOutput, createPdf, createPdfAsync, createPdfStream, getImageDimensions } = nativeBinding
