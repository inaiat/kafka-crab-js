...
const __wasmUrl = new URL('./pdf-crab-js.wasm32-wasip1.wasm', import.meta.url).href
...
export const PdfDocumentBuilder = __napiModule.exports.PdfDocumentBuilder
export const PdfOutput = __napiModule.exports.PdfOutput
export const createPdf = __napiModule.exports.createPdf
export const createPdfAsync = __napiModule.exports.createPdfAsync
export const createPdfStream = __napiModule.exports.createPdfStream
export const getImageDimensions = __napiModule.exports.getImageDimensions
