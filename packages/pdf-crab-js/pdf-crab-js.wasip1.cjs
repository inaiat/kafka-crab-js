// napi-rs-artifact-metadata:{"version":2,"rootEntry":"js-binding.cjs","exports":["PdfDocumentBuilder","PdfOutput","createPdf","createPdfAsync","createPdfStream","getImageDimensions"],"managedRootEntries":["browser.js","js-binding.cjs","pdf-crab-js.wasm","pdf-crab-js.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
let __wasmFilePath = __nodePath.join(__dirname, 'pdf-crab-js.wasm32-wasip1.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'pdf-crab-js.wasm32-wasip1.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  const __wasiPackageEntry = require.resolve('pdf-crab-js-wasm32-wasip1')
  const __packagedWasmFilePath = __nodePath.join(
    __nodePath.dirname(__wasiPackageEntry),
    'pdf-crab-js.wasm32-wasip1.wasm',
  )
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      'pdf-crab-js-wasm32-wasip1 is installed but is missing pdf-crab-js.wasm32-wasip1.wasm.',
    )
  }
...
module.exports.PdfDocumentBuilder = __napiModule.exports.PdfDocumentBuilder
module.exports.PdfOutput = __napiModule.exports.PdfOutput
module.exports.createPdf = __napiModule.exports.createPdf
module.exports.createPdfAsync = __napiModule.exports.createPdfAsync
module.exports.createPdfStream = __napiModule.exports.createPdfStream
module.exports.getImageDimensions = __napiModule.exports.getImageDimensions
