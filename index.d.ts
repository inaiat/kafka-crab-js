...
export class KafkaStreamConsumer {
  ...
  commit(partition: number, offset: number): void
  commitConsumerState(): void
}
...
export class KafkaClient {
  ...
  createStreamConsumer(consumerConfiguration: ConsumerConfiguration): Promise<KafkaStreamConsumer>
}
